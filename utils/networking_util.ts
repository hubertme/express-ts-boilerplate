...
export default class NetworkingUtil {
     ...
     */
    private static async request(url: string, method: "GET" | "POST" | "PUT" | "DELETE" | "OPTIONS" | "PATCH", params: {[key: string]: any} = {}, data: {[key: string]: any} = {}, headers: {[key: string]: any} = {}): Promise<Response> {
        try {
